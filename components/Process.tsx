...
function Process({}: Props) {
  return (
    <div className="relative z-0 w-[100%] bg-gradient-to-t from-black/0 to-black/50">
      <CldImage
        ...
        height="1080"
        sizes="100h"
        className="h-[250vh] w-[100%] bg-gradient-to-b from-black/90 to-black/0 opacity-40 object-cover"
      />
